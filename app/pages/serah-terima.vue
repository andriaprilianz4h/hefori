...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6 space-y-6"
  >
    <!-- Header Progress -->
    <div class="max-w-4xl mx-auto">
      ...
      >
        ...
        <div class="bg-white rounded-2xl p-4 shadow-sm flex items-center gap-4">
          ...
          <UBadge
            :color="
              patientData.status === 'Terverifikasi' ? 'emerald' : 'amber'
            "
            variant="soft"
            size="lg"
        ...
        <!-- Logistics Status -->
        <UCard
          class="rounded-2xl shadow-lg border-0 bg-gradient-to-br from-white to-gray-50"
        >
          <template #header>
          ...
          >
            ...
            <div class="text-sm text-blue-800">
              ...
              <p>
                Semua logistik harus tersedia sebelum pasien dapat dipindahkan
                ke area OK. Jika ada keterlambatan logistik, segera hubungi
                koordinator OK.
              </p>
            </div>
          </div>
      ...
      >
        <!-- Handover Header -->
        <UCard
          class="rounded-2xl shadow-lg border-0 overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50"
        >
          <div
            class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-teal-400"
          />
          <div
            class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4"
          >
            ...
            >
              <div class="flex items-center gap-2">
                <span
                  ...
                  :class="{
                    'bg-red-100 text-red-700': category === 'Situation',
              ...
              <div class="space-y-2 ml-4">
                <div
                  ...
                  :class="[
                    ...
                    item.critical ? 'border-l-4 border-l-red-400' : ''
                  ]"
                  @click="item.checked = !item.checked"
                >
                  <div
        ...
        <!-- Final Actions -->
        <UCard
          class="rounded-2xl shadow-lg border-0 bg-gradient-to-r from-emerald-50 to-teal-50"
        >
          <div
